...
class stage01_resequencing_analysis_query(sbaas_template_query):
    ...
    def drop_dataStage01_resequencing_analysis(self):
        try:
            data_stage01_resequencing_analysis.__table__.drop(self.engine,True);
    ...
    def reset_dataStage01_resequencing_analysis(self,analysis_id_I = None):
        try:
            ...
            print(e);
    def initialize_dataStage01_resequencing_analysis(self):
        try:
            data_stage01_resequencing_analysis.__table__.create(self.engine,True);
        except SQLAlchemyError as e:
            print(e);
    ...
    def add_dataStage01ResequencingAnalysis(self, data_I):
        ...
        if data_I:
            for d in data_I:
                try:
                    data_add = data_stage01_resequencing_analysis(
                        d['analysis_id'],
                        d['experiment_id'],
                        d['lineage_name'],
                        d['sample_name'],
