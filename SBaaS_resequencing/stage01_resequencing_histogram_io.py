#sbaas
from .stage01_resequencing_histogram_query import stage01_resequencing_histogram_query
#sbaas models
...
class stage01_resequencing_histogram_io(stage01_resequencing_histogram_query,sbaas_template_io):

    def import_dataStage01ResequencingHistogram_add(self, filename):
        '''table adds'''
        data = base_importData();
        data.read_csv(filename);
        data.format_data();
        self.add_dataStage01ResequencingHistogram(data.data);
        data.clear_data();
